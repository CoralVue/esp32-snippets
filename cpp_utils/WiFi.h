...
private:
    ...
    bool                m_doingSmartConfig;
    wifi_config_t       m_smart_wifi_config;
    WiFiEventHandler*   m_smart_event_handler;
    static std::string         m_clientName;
public:
    WiFi();
    ~WiFi();
    ...
    uint8_t                   connectAP(const std::string& ssid, const std::string& password, const std::string& clientName = "", bool waitForConnection = true);
    void                      reconnect();
    void                      dump();
    ...
    void                      addWifiEventHandler(WiFiEventHandler *wifiEventHandler);
    void                      removeWifiEventHandler(WiFiEventHandler *wifiEventHandler);
    uint8_t                   doSmartConnect();
    void                      stationStarted();
    wifi_config_t&            getSmartConfigData();
    WiFiEventHandler*         getSmartEventHandler() {
        return m_smart_event_handler;
